...
Mobile.verifyElementText(findTestObject('Account/Text - Account 1 Name (tesaccount)'), 'tesaccount')

Mobile.verifyElementText(findTestObject('Account/Text - Account 1 Balance (1000)'), 'Account balance: $1000.00')

Mobile.verifyElementText(findTestObject('Account/Text - Account 1 Number (A1)'), 'Account no: A1')
