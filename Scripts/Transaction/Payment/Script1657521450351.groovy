...
if(Integer.parseInt(account1_balance) - 300 >= min_limit) {
	...
	Mobile.verifyElementText(findTestObject('Account/Text - Account 1 Balance (1000)'), 'Account balance: $1000.00')
}
...
if(Integer.parseInt(account2_balance) - 300 >= min_limit) {
	...
	Mobile.verifyElementText(findTestObject('Account/Text - Account 2 Balance (2000)'), 'Account balance: $2000.00')
}
